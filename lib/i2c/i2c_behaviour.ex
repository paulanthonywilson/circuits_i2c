defmodule Circuits.I2C.I2cBehaviour do
  ...
  of testing, for example by using [Mox](https://hexdocs.pm/mox/).
  """
  ...
  @callback write_read!(bus(), address(), iodata(), pos_integer()) :: binary()
